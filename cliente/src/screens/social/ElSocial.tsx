...
const ElSocial: React.FC = () => {
    ...
    const handlePublish = () => {
        ...
        addNotification({
            type: 'system',
            title: '¡Avistamiento Compartido!',
            message: 'Tu nota ha sido publicada en el muro de la comunidad.'
        });
    };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-8 animate-slide-up">
                        <div className="flex items-center justify-between px-2">
                            <h3 className="text-xl font-black uppercase tracking-wider">Mi Bandada</h3>
                            <span className="text-[10px] font-black text-primary bg-primary/10 px-3 py-1 rounded-lg">COOPERATIVO</span>
                        </div>
                        ...
                        {userGuild ? (
                            <GlassPanel className="p-8 relative overflow-hidden group border-2 border-white/50 shadow-2xl">
                                <div className="flex items-center gap-5 mb-8">
                                    ...
                                    <div className="text-left">
                                        <h4 className="text-2xl font-black leading-none mb-2">{userGuild.name}</h4>
                                        <div className="flex items-center gap-2">
                                            <span className="bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-400 text-[10px] font-black px-2.5 py-1 rounded-md uppercase tracking-widest">NV {userGuild.level}</span>
                                            <span className="text-xs font-bold text-slate-400">• {userGuild.members} Naturalistas</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-slate-50/80 dark:bg-slate-950/40 p-6 rounded-[2rem] border border-white/40 dark:border-white/5 shadow-inner mb-8 transition-transform hover:scale-[1.02]">
                                    <div className="flex justify-between items-center mb-3">
                                        <span className="text-[10px] font-black text-primary uppercase flex items-center gap-2 tracking-widest">
                                            <span className="material-symbols-outlined text-sm">flag_circle</span> Misión Global
                                        </span>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-[10px] font-black tracking-widest mb-1">
                                            <span className="text-slate-400 uppercase">Progreso Colectivo</span>
                                    ...
                                    <button
                                        ...
                                        className="mt-5 w-full py-3 bg-white/50 dark:bg-white/5 hover:bg-white text-[10px] font-black uppercase tracking-widest rounded-xl border border-white/50 transition-all text-left px-5 flex items-center justify-between group"
                                    >
                                        Aportar Avistamiento
                                ...
                                >
                                    <span className="material-symbols-outlined text-lg">forum</span> Abrir Canal de Voz
                                </button>
                            </GlassPanel>
                        ) : (
                            <GlassPanel className="p-10 text-center flex flex-col items-center border-dashed border-2 border-primary/30">
                                ...
                                <h4 className="font-black text-2xl mb-3">Busca tu Bandada</h4>
                                <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 max-w-xs italic font-bold">Únete a un grupo de expertos para desbloquear biomas raros y recompensas exclusivas de Pinto.</p>
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                addNotification({
                                                    type: 'system',
                                                    title: 'Bandada Unida',
                                                    message: `Te has unido a ${g.name}. ¡Bienvenido!`,
                                                });
                                            }}
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-8 animate-slide-up delay-100">
                        <div className="flex items-center justify-between px-2">
                            <h3 className="text-xl font-black uppercase tracking-wider">Muro de Avistamientos</h3>
                            ...
                            <div className="flex gap-5">
                                ...
                                <div className="flex-grow">
                                    <textarea
                                        ...
                                        placeholder="Comparte un hallazgo, una duda o simplemente saluda..."
                                        className="w-full bg-slate-50/50 dark:bg-slate-950/30 border-none rounded-[1.5rem] px-6 py-4 text-base focus:ring-2 focus:ring-primary/40 resize-none font-medium placeholder:italic text-left"
                                        rows={3}
                                    />
                                    ...
                                    <div className="flex flex-wrap items-center justify-between mt-5 gap-4">
                                        <div className="flex gap-2">
                                            <button
                                                ...
                                                className="px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all"
                                            >
                                                <span className="material-symbols-outlined text-base">photo_camera</span> Adjuntar Foto
                                            </button>

                                            <div className="relative group">
                                                <button className={`px-4 py-2 ${selectedBirdId ? 'bg-primary text-slate-900' : 'bg-slate-100 dark:bg-slate-800'} rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all`}>
                                        ...
                                        >
                                            Publicar <span className="material-symbols-outlined text-sm">send</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="p-8">
                                        <div className="flex items-center justify-between mb-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="text-left">
                                                    <h5 className="font-black text-base leading-none mb-1">{post.userName}</h5>
                                        ...
                                        <p className="text-lg font-medium mb-6 leading-relaxed italic text-left">"{post.text}"</p>
                                        ...
                                        {post.birdId && (
                                            <div className="mb-6 bg-slate-50 dark:bg-slate-950/40 p-4 rounded-3xl border border-slate-100 dark:border-white/5 flex gap-4 items-center group/card hover:bg-primary/5 transition-colors cursor-pointer text-left">
                                                ...
                                                <div className="flex-grow">
                                                    <p className="text-[9px] font-black text-primary uppercase tracking-[0.2em] mb-1">Especie Vinculada</p>
                                                    <h4 className="text-lg font-black leading-none">{BIRD_CATALOG.find(b => b.id === (post.birdId || ''))?.name}</h4>
                                        ...
                                        <div className="flex items-center justify-between border-t border-slate-100 dark:border-slate-800/50 pt-6">
                                            ...
                                            <button className="flex items-center gap-2 text-slate-400 hover:text-blue-500 transition-colors group/comment">
                                                <span className="text-[10px] font-black uppercase tracking-widest mr-1 opacity-0 group-hover/comment:opacity-100 transition-opacity">Responder</span>
                ...
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in text-slate-900">
                    <div className="bg-[#fcfaf0] dark:bg-slate-950 rounded-[3rem] shadow-2xl w-full max-w-lg h-[650px] flex flex-col overflow-hidden animate-scale-in border-8 border-white dark:border-slate-800 relative">
                        ...
                        <header className="p-8 pb-6 border-b border-amber-900/10 dark:border-slate-800 flex justify-between items-center text-left">
                            <div className="text-left">
                                <h3 className="font-black text-2xl flex items-center gap-3 italic font-handwriting">
                                    <span className="material-symbols-outlined text-primary text-3xl">forum</span> Canal: {userGuild.name}
                                </h3>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1 ml-10">4 Miembros conectados</p>
                            </div>
                            <button onClick={() => setIsChatOpen(false)} className="p-3 rounded-2xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 transition-colors">
                                <span className="material-symbols-outlined">close</span>
                            </button>
                        </header>

                        <div className="flex-grow p-8 overflow-y-auto space-y-6 custom-scrollbar flex flex-col">
                            <p className="text-center text-[10px] font-black text-slate-300 uppercase tracking-[0.3em] mb-4">Registro del {new Date().toLocaleDateString()}</p>

                            {currentChat.length === 0 ? (
                                <div className="flex-grow flex flex-col items-center justify-center opacity-20 grayscale py-10">
                                    <span className="material-symbols-outlined text-6xl">history_edu</span>
                                    <p className="font-handwriting text-xl mt-2 italic font-bold">Sin mensajes hoy...</p>
                                </div>
                            ) : (
                                currentChat.map((msg) => (
                        ...
                        <footer className="p-8 pt-4 bg-white/50 dark:bg-slate-900/50 border-t border-amber-900/10 dark:border-slate-800 flex gap-3 items-end">
                            <div className="flex-grow bg-white dark:bg-slate-800 rounded-2xl shadow-inner border border-amber-100/50 dark:border-slate-700 px-5 py-3 relative">
                                <textarea
                                    ...
                                    className="w-full bg-transparent border-none p-0 text-sm focus:ring-0 resize-none font-medium h-10 max-h-32 text-left"
