        ...
        (set, get) => {
            ...
            return {
                ...
                addPost: async (post) => {
                    ...
                    try {
                        const newPostFromServer = await api.post('/social/posts', {
                            text: post.text,
                ...
                addComment: async (postId: string, text: string) => {
                    try {
                        ...
                        const newCommentFromServer = await api.post(`/social/posts/${postId}/comment`, {
