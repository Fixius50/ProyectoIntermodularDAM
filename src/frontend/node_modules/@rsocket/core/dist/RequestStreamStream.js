...
class RequestStreamRequesterStream {
    constructor(payload, receiver, fragmentSize, initialRequestN, leaseManager) {
    ...
    handleReady(streamId, stream) {
        ...
        if ((0, Fragmenter_1.isFragmentable)(this.payload, this.fragmentSize, Frames_1.FrameTypes.REQUEST_STREAM)) {
            for (const frame of (0, Fragmenter_1.fragmentWithRequestN)(streamId, this.payload, this.fragmentSize, Frames_1.FrameTypes.REQUEST_STREAM, this.initialRequestN)) {
...
class RequestStreamResponderStream {
