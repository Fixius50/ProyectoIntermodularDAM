...
class RequestResponseRequesterStream {
    ...
    handleReady(streamId, stream) {
        ...
        if ((0, Fragmenter_1.isFragmentable)(this.payload, this.fragmentSize, Frames_1.FrameTypes.REQUEST_RESPONSE)) {
            for (const frame of (0, Fragmenter_1.fragment)(streamId, this.payload, this.fragmentSize, Frames_1.FrameTypes.REQUEST_RESPONSE)) {
    ...
    handle(frame) {
        ...
        switch (frameType) {
            case Frames_1.FrameTypes.PAYLOAD: {
                ...
                const hasPayload = Frames_1.Flags.hasNext(frame.flags);
...
class RequestResponseResponderStream {
    ...
    onNext(payload, isCompletion) {
        ...
        if ((0, Fragmenter_1.isFragmentable)(payload, this.fragmentSize, Frames_1.FrameTypes.PAYLOAD)) {
            for (const frame of (0, Fragmenter_1.fragment)(this.streamId, payload, this.fragmentSize, Frames_1.FrameTypes.PAYLOAD, true)) {
                this.stream.send(frame);
            }
        }
        else {
