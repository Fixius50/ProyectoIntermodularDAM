...
public class WikidataBirdService {
    ...
    private Flux<BirdRecord> parseWikidataResponse(String response) {
        ...
        // En una app real usaríamos una librería como Jackson o Gson con un DTO más
        // complejo
        return Flux.just(
                BirdRecord.builder()
                        .id(1L)
                        ...
                        .imagenUrl(
                                "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Pica_pica_-_01.jpg/500px-Pica_pica_-_01.jpg")
                        .build());
    }
}
